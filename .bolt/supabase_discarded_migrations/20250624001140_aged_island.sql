/*
  # Create Student Scholarship Tables

  1. New Tables
    - `student_scholarship_settings`
      - `id` (uuid, primary key)
      - `name` (text)
    ...
    - `student_scholarship_applications_archive`
      - Same fields as `student_scholarship_applications` plus:
