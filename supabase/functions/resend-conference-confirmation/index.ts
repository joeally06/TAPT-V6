...
Deno.serve(async (req) => {
  ...
  try {
    ...
    console.log('📧 Resending conference confirmation email for registration:', registrationId);
    ...
    const emailData: ConferenceRegistrationData = {
      ...
      conferenceName: conferenceSettings?.name || conferenceSettings?.conference_name || 'TAPT Annual Conference',
    ...
    console.log('✅ Conference confirmation email resent successfully to:', registration.email);
