/*
  # Add linked_form_type to content table

  1. New Columns
    - `linked_form_type` (text, nullable) - Stores the type of form to link to (conference, tech-conference, hall-of-fame)
  
  2. Changes
    - Adds a new column to the content table to allow linking events to registration forms
    - Adds a check constraint to ensure valid form types
*/
